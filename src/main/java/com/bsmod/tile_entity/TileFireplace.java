...
import com.bsmod.block.blockFireplace;
...
public class TileFireplace extends TileEntity implements ISidedInventory {
	...
	public String getInventoryName() {
		return this.hasCustomInventoryName() ? this.field_145958_o : "container.fireplace";
	}
	...
	public void updateEntity() {
		...
		if (!this.worldObj.isRemote) {
			if (this.burnTime != 0
					|| this.itemStacks[1] != null && this.itemStacks[0] != null) {
				if (this.burnTime == 0 && this.canSmelt()) {
					this.currentItemBurnTime = this.burnTime = getItemBurnTime(this.itemStacks[1]) * updateScale;
					...
					if (this.burnTime > 0) {
						...
						if (this.itemStacks[1] != null) {
							...
							if (this.itemStacks[1].stackSize == 0) {
								this.itemStacks[1] = itemStacks[1].getItem()
										.getContainerItem(itemStacks[1]);
							}
						}
					}
				}
			...
			if (flag != this.burnTime > 0) {
				flag1 = true;
				blockFireplace.updateBlockState(this.burnTime > 0, this.worldObj, this.xCoord, this.yCoord,
						this.zCoord);
			}
		}
